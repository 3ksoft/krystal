...
export const SIZEOF_Sampler = 1;
export const SIZEOF_Generate = 28;
export const SIZEOF_Cancel = 8;
export const SIZEOF_EngineCommand = 29;
export const SIZEOF_ErrorCode = 1;
export const SIZEOF_Completed = 4;
export const SIZEOF_TokenEmitted = 8;
export const SIZEOF_ExecutionStats = 48;
export const SIZEOF_Failed = 8;
export const SIZEOF_EngineEvent = 49;
