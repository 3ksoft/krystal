...
import { getTrainingHarness, createWeightPage, readArenaRegion, runPassWait, uploadArena } from "./harness.ts";
import { KRYSTAL_FORWARD_ARENA, KRYSTAL_FORWARD_ARENA_BASE } from "../src/krystal-layout.ts";
import {
  brainForwardOracle,
  matmulOracle,
  reluOracle,
...
import { attentionOracle } from "../../krystal/src/forward/oracle.ts";
