...
import { shaderIncludes, shaderSources } from "./shaders.generated";
...
/** Browser/runtime-safe WGSL lookup. Sources are generated from src/shaders. */
export function getWgsl(shader: Lfm2ShaderName): string {
  return shaderSources[shader];
}
